...
options.AddVariables(('CXX', 'C++ compiler', default_cxx),
                     ...
                     ('GLEW_ROOT', 'glew prefix', ''),
                     ('GLEW_INC_DIR', 'glew includes path ($GLEW_ROOT/include)', ''),
                     ('GLEW_LIB_DIR', 'glew library path ($GLEW_ROOT/lib)', ''),
                     ('GLEW_LIB_NAME', 'glew library name', 'GLEW'),
