...
namespace {
    ...
    bool init_glew()
    {
        ...
        try{
            ...
            g_lit_particle_vertex = GLProgram::create_program(GL_VERTEX_SHADER, 1, "#version 110\n"\
...
"}\n");
            ...
            std::shared_ptr<GLProgram> lit_particle_fragment = GLProgram::create_program(GL_FRAGMENT_SHADER, 1, "#version 110\n"\
"void main(void)\n"\
"{\n"\
